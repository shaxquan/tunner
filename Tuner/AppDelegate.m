...
{
    [TestFlight takeOff:@"a3c7f478caa1fabbb49def8c4fd11150_MTcwNjUxMjAxMi0xMi0zMCAwODo1MTowNi43MjA3OTc"];
...
//    self.window.backgroundColor = [UIColor whiteColor];
    ...
    MusicalInstrumentListViewController *viewController1 = [[[MusicalInstrumentListViewController alloc] initWithNibName:nil bundle:nil] autorelease];
    ...
    AboutViewController *viewController2 = [[[AboutViewController alloc] initWithNibName:nil bundle:nil] autorelease];
